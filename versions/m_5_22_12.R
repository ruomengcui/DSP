...
if(make.plots){
	...
	plot.theory.policies(12, c(1, 8), list(c(expression(alpha[0]==5^-2), expression(alpha[0]==5^-1), expression(alpha[0]==5^0), expression(alpha[0]==5^1), expression(alpha[0]==5^2)), c(expression(beta[4]==5^-2), expression(beta[4]==5^-1), expression(beta[4]==5^0), expression(beta[4]==5^1), expression(beta[4]==5^2))))	
	plot.theory.policies(12, c(4, 8), list(c(expression(alpha[3]==5^-2), expression(alpha[3]==5^-1), expression(alpha[3]==5^0), expression(alpha[3]==5^1), expression(alpha[3]==5^2)), c(expression(beta[4]==5^-2), expression(beta[4]==5^-1), expression(beta[4]==5^0), expression(beta[4]==5^1), expression(beta[4]==5^2))))		
}
